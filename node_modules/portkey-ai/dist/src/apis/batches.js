...
class Batches extends apiResource_1.ApiResource {
    create(_body, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield OAIclient.batches.create(body, opts).withResponse();
            return (0, utils_1.finalResponse)(result);
        });
    }
    retrieve(batchID, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (params) {
                const config = (0, utils_1.overrideConfig)(this.client.config, params.config);
                this.client.customHeaders = Object.assign(Object.assign({}, this.client.customHeaders), (0, createHeaders_1.createHeaders)(Object.assign(Object.assign({}, params), { config })));
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.batches
    ...
    list(_query, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const result = yield OAIclient.batches.list(query, opts).withResponse();
            return (0, utils_1.finalResponse)(result);
        });
    }
    cancel(batchID, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (params) {
                const config = (0, utils_1.overrideConfig)(this.client.config, params.config);
                this.client.customHeaders = Object.assign(Object.assign({}, this.client.customHeaders), (0, createHeaders_1.createHeaders)(Object.assign(Object.assign({}, params), { config })));
    ...
    output(batchId, params, opts) {
        if (params) {
            const config = (0, utils_1.overrideConfig)(this.client.config, params.config);
            this.client.customHeaders = Object.assign(Object.assign({}, this.client.customHeaders), (0, createHeaders_1.createHeaders)(Object.assign(Object.assign({}, params), { config })));
        }
        const response = this.getMethod(`/batches/${batchId}/output`, opts);
        return response;
    }
}
