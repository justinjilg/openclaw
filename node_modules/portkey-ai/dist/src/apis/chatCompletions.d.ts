...
declare class ChatCompletions extends ApiResource {
    ...
    delete(completionID: string, params?: ApiClientInterface, opts?: RequestOptions): APIPromise<ChatCompletion>;
    parse(body: any, params?: ApiClientInterface, opts?: RequestOptions): Promise<any>;
    stream(body: any, params?: ApiClientInterface, opts?: RequestOptions): Promise<any>;
