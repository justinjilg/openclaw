...
class Realtime extends apiResource_1.ApiResource {
    constructor(client) {
        super(client);
...
class Sessions extends apiResource_1.ApiResource {
    create(_body, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield OAIclient.beta.realtime.sessions
                .create(body, opts)
                .withResponse();
...
class TranscriptionSessions extends apiResource_1.ApiResource {
    create(_body, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const body = _body;
            if (params) {
            ...
            const OAIclient = (0, utils_1.initOpenAIClient)(this.client);
            const response = yield OAIclient.beta.realtime.transcriptionSessions
                .create(body, opts)
                .withResponse();
