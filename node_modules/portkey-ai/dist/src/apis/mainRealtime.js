...
exports.Calls = exports.ClientSecrets = exports.MainRealtime = void 0;
const apiResource_1 = require("../apiResource.js");
const utils_1 = require("../utils.js");
const createHeaders_1 = require("./createHeaders.js");
class MainRealtime extends apiResource_1.ApiResource {
    constructor(client) {
        super(client);
...
exports.MainRealtime = MainRealtime;
class ClientSecrets extends apiResource_1.ApiResource {
    constructor(client) {
        super(client);
    }
    create(_body, params, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield OAIclient.realtime.clientSecrets
                .create(body, opts)
                .withResponse();
...
class Calls extends apiResource_1.ApiResource {
    constructor(client) {
        super(client);
    }
    accept(callID, body, params, opts) {
        if (params) {
            const config = (0, utils_1.overrideConfig)(this.client.config, params.config);
            this.client.customHeaders = Object.assign(Object.assign({}, this.client.customHeaders), (0, createHeaders_1.createHeaders)(Object.assign(Object.assign({}, params), { config })));
        }
    ...
    reject(callID, body = {}, params, opts) {
        if (params) {
            const config = (0, utils_1.overrideConfig)(this.client.config, params.config);
            this.client.customHeaders = Object.assign(Object.assign({}, this.client.customHeaders), (0, createHeaders_1.createHeaders)(Object.assign(Object.assign({}, params), { config })));
        }
...
exports.Calls = Calls;
//# sourceMappingURL=mainRealtime.js.map